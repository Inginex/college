...
public void save(Funcionarios funcionario){
 ...
 String sql = "INSERT INTO funcionarios(id, nume_func, cargo, endereco, contato)" +
 " VALUES(?,?,?,?,?)";
 ...
 pstm.setString(5, funcionario.getContato());
 ...
 String sql = "UPDATE funcionario SET nome_fun = ?, cargo = ?, endereco = ? , contato = ?" +
 " WHERE id = ?";
 ...
 funcionario.setFuncionario(rset.getString("nome_fun"));
 funcionario.setCargo(rset.getString("cargo"));
 funcionario.setEndereco(rset.getString("endereco"));
 funcionario.setContato(rset.getString("contato"));
